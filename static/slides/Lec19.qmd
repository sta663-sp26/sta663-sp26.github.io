...
with banana:
  trace = pm.sample(draws=50000, chains=1, random_seed=1234, progressbar=False)
...
plt.figure(layout="constrained")
plt.subplot(211)
plt.plot(mh_more2.posterior["x1"].sel(chain=0).values, label="x1")
plt.legend()

plt.subplot(212)
plt.plot(mh_more2.posterior["x2"].sel(chain=0).values, label="x2")
plt.legend()
...
mh_trajectories(mh_more2, chains=[0])
...
```{python}
#| echo: false
ax = az.plot_autocorr(mh_more2.sel(chain=0), max_lag=50)
plt.show()
```
:::
...
#| echo: false
with bv_normal:
  bv_trace = pm.sample(draws=10000, chains=1, random_seed=1234, progressbar=False, cores=1)
...
plt.figure(layout="constrained")
plt.subplot(211)
plt.plot(slice_banana.posterior["x1"].sel(chain=0).values, label="x1")
plt.legend()

plt.subplot(212)
plt.plot(slice_banana.posterior["x2"].sel(chain=0).values, label="x2")
plt.legend()
...
mh_trajectories(slice_banana, chains=[0])
...
```{python}
#| echo: false
ax = az.plot_autocorr(slice_banana.sel(chain=0), max_lag=50)
plt.show()
```
:::
...
plt.figure(layout="constrained")
plt.subplot(211)
plt.plot(slice_bvn.posterior["x1"].sel(chain=0).values, label="x1")
plt.legend()

plt.subplot(212)
plt.plot(slice_bvn.posterior["x2"].sel(chain=0).values, label="x2")
plt.legend()
...
mh_trajectories(slice_bvn, chains=[0])
...
```{python}
#| echo: false
ax = az.plot_autocorr(slice_bvn.sel(chain=0), max_lag=50)
plt.show()
```
:::
