...
plt.figure()
sns.scatterplot(data=books, x="volume", y="weight", hue="cover")
sns.lineplot(data=books, x="volume", y="pred2", hue="cover")
plt.show()
```
...
```{python}
#| echo: false
books["resid2"] = books["weight"] - books["pred2"]

plt.figure(layout="constrained")
ax = sns.scatterplot(data=books, x="volume", y="resid2", hue="cover")
ax.axhline(c="k", ls="--", lw=1)
plt.show()
```
...
## What about step parameters? {.scrollable}
...
## Pipeline parameter names {.scrollable}
...
## Keeping or dropping other columns {.scrollable}
