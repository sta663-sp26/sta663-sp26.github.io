...
::: {.aside}
See [`itertools.zip_longest()`](https://docs.python.org/3/library/itertools.html#itertools.zip_longest) if you want to iterate until the longest sequence is exhausted
:::
