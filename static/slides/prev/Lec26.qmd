...
&nbsp; &nbsp; {{< fa file >}} &nbsp; `Lec26/bernoulli.stan`
:::
```stan
{{< include Lec26/bernoulli.stan >}}
```

::: {.code-file .sourceCode .cell-code}
&nbsp; &nbsp; {{< fa file >}} &nbsp; `Lec26/bernoulli.json`
:::
```json
{{< include Lec26/bernoulli.json >}}
```
:::
...
model = CmdStanModel(stan_file='Lec26/bernoulli.stan')
```

```{python}
fit = model.sample(data='Lec26/bernoulli.json', show_progress=False)
```
:::
...
::: {.xsmall}
::: {.code-file .sourceCode .cell-code}
&nbsp; &nbsp; {{< fa file >}} &nbsp; `Lec26/gp.stan`
:::
```stan
{{< include Lec26/gp.stan >}}
```
:::
...
```{python}
#| warning: true
gp = CmdStanModel(stan_file='Lec26/gp.stan')
...
```{python}
import nutpie
m = nutpie.compile_stan_model(filename="Lec26/gp.stan")
...
::: {.xxsmall}
::: {.code-file .sourceCode .cell-code}
&nbsp; &nbsp; {{< fa file >}} &nbsp; `Lec26/gp2.stan`
:::
```stan
{{< include Lec26/gp2.stan >}}
```
:::
...
```{python}
#| warning: true
gp2 = CmdStanModel(stan_file='Lec26/gp2.stan')
