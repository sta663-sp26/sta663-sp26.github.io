...
Python is not quite as liberal as R when it comes to type coercion, but there are some idiosyncratic overloads
...
There is also a `None` type which is similar in usage and functionality to `NULL` in R.
