...
Because string processing is a common and important programming task, the `str` class implements a number of additional methods for to support these tasks. 
