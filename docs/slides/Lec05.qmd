...
urlparse("https://duke.edu/path?x=1")
```
...
::: {.aside}
If you want to change the working directory of your Python session use `os.chdir("path/")`.
:::
...
::: {.aside}
Also useful for configuring tools like Pyrefly
:::
