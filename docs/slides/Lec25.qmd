...
::: {.aside}
Using a class like a function is often referred to as a functor
:::
...
## MNIST handwritten digits - simplified {.scrollable}
...
From the pytorch [documentation](https://docs.pytorch.org/docs/stable/generated/torch.nn.CrossEntropyLoss.html):
...
::: {.aside}
mean is the default reduction method, and is the one we used here
:::
...
## Out-of-sample accuracy {.scrollable}

:::: {.columns .xxsmall .limit400}
::: {.column width='50%' }
```{python}
model(X_test)
```
